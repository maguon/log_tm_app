            ...
            <View style={{ backgroundColor: '#fff', marginTop: 10, flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flexDirection: 'row', paddingVertical: 10, alignSelf: 'center' }}>
                        ...
                        {this.props.type == 1 && <FontTag size={26} title='协' color='#12c3eb' fontColor='#fff' />}
                        {this.props.type == 2 && <FontTag size={26} title='供' color='#12c3eb' fontColor='#fff' />}
                        {this.props.type == 3 && <FontTag size={26} title='包' color='#12c3eb' fontColor='#fff' />}
                    </View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ paddingVertical: 10, paddingHorizontal: 10, alignSelf: 'flex-end' }}>
