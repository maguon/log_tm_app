...
const RepairStationOptionalSearchBar = props => {
    const { layout } = props
    return (
        <View style={[styles.container, { width: layout.initWidth }]}>
            ...
            <Header
                ...
                <Body style={styles.body}>
                    <Field name='repairStation' component={TextBox} />
                </Body>
            </Header>
        </View>
    )
...
export default reduxForm({
    form: 'repairStationOptionalSearchForm'
})(RepairStationOptionalSearchBar)
